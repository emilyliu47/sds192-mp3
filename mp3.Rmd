...
leaflet() %>%
  ...
  addMarkers(data = campsites_sf, popup = ~point, labelOptions = labelOptions(style = ("color" = "red")))
...
map <- leaflet() %>%
  ...
  # campsite markers
  addMarkers(data = campsites_sf, popup = ~point, labelOptions = labelOptions(color = "black")) %>%
  # campsite forest
