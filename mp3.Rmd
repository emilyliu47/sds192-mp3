...
map <- leaflet() %>%
  ...
  # contour lines
  addPolylines(data = macleish_layers[["contours_3m"]], weight = 1, color = "black") %>%
  # macleish wetlands
  ...
  addMarkers(data = campsites_sf, popup = ~point) %>%
  # campsite forest
  addPolygons(data = pine_maple, weight = 1, color = "red") %>%
  ...
  addPolygons(data = parking_bf, color = "green", fillColor = "transparent") %>%
